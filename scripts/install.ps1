# ops-hub one-shot install script for Windows (PowerShell 5.1+)
#
# What it does:
...
function Write-Info($msg)  { Write-Host "[ops-hub] $msg" -ForegroundColor Green }
function Write-Warn($msg)  { Write-Host "[ops-hub] WARN: $msg" -ForegroundColor Yellow }
function Write-Fail($msg)  { Write-Host "[ops-hub] ERROR: $msg" -ForegroundColor Red; exit 1 }
...
OPSHUB_HOST=127.0.0.1
OPSHUB_PORT=8001
OPSHUB_DEV=0

# Session signing key (keep secret, do not change once set)
OPSHUB_SECRET=$Secret

OPSHUB_USER=admin
OPSHUB_PASSWORD_HASH=$PwHash

# Set this to your public URL (used for CSRF protection)
OPSHUB_ALLOWED_ORIGINS=http://127.0.0.1:8001
"@
...
Write-Host "  ops-hub install complete!" -ForegroundColor Green
Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Green
Write-Host ""
