import { Settings, Sparkles, PanelLeftOpen, Terminal } from 'lucide-react';
...
export default function SidebarCollapsed({
  ...
  return (
    <div className="flex h-full w-12 flex-col items-center bg-background/80 py-3 backdrop-blur-sm">
      {/* Brand icon */}
      ...
      {updateAvailable && (
        <button
          ...
          className="relative mb-1 flex h-8 w-8 items-center justify-center rounded-lg transition-colors hover:bg-accent/80"
      ...
      {/* Divider */}
      <div className="my-1 w-6 nav-divider" />
